...
Route::middleware(['auth.custom'])->group(function () {
    ...
    Route::get('/student-ledger/previous-balance', [StudentLedgerController::class, 'getPreviousBalance'])->name('student-ledger.previous-balance');
    Route::get('/student-ledger/export', [StudentLedgerController::class, 'exportBalanceSheet'])->name('student-ledger.export');
    Route::get('/student-ledger/{studentId}', [StudentLedgerController::class, 'show'])->name('student-ledger.show');

    Route::get('/previous-balances', [PreviousBalanceController::class, 'index'])->name('previous-balances.index');
    Route::post('/previous-balances/carry-forward', [PreviousBalanceController::class, 'carryForward'])->name('previous-balances.carry-forward');
    Route::post('/previous-balances/bulk-carry-forward', [PreviousBalanceController::class, 'bulkCarryForward'])->name('previous-balances.bulk-carry-forward');
