...
<link rel="stylesheet" href="{{ asset('css/theme.css') }}">
    ...
    <script>
        (function () {
            var saved = localStorage.getItem('pa-theme') || 'light';
    ...
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .topbar-left  { font-size: .84rem; font-weight: 600; }
    ...
    /* Section cards */
    .section-card { border: none !important; border-radius: 10px !important; margin-bottom: 20px; overflow: hidden; }
    .section-card .card-header { border-bottom: 2px solid #e2e8f0 !important; padding: 11px 20px; display: flex; align-items: center; gap: 8px; }
    ...
    .section-card .card-header h6 { margin: 0; font-weight: 700; font-size: .88rem; }
    .section-card > .card-body { padding: 20px; }

    /* Forms */
    .form-label { font-size: .79rem; font-weight: 600; margin-bottom: 4px; }
    .form-control, .form-select { border-radius: 8px !important; font-size: .875rem; padding: 8px 12px; }
    .form-control:focus, .form-select:focus { border-color: #3b82f6 !important; box-shadow: 0 0 0 3px rgba(59,130,246,.12) !important; }

    /* Table */
    .pa-table thead th { font-size: .76rem; font-weight: 600; letter-spacing: .35px; padding: 11px 16px; border: none; white-space: nowrap; }
    .pa-table tbody td { padding: 10px 16px; vertical-align: middle; font-size: .85rem; }
    ...
    /* Save button */
    .btn-save { color: #fff !important; border: none; border-radius: 9px; padding: 11px 22px; font-weight: 700; font-size: .9rem; display: inline-flex; align-items: center; gap: 7px; transition: opacity .15s; cursor: pointer; }
...
<script>
    (function () {
        ...
        paintIcon(document.documentElement.getAttribute('data-theme') || 'light');
