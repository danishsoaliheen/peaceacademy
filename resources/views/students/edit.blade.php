...
{{-- ── Alerts ───────────────────────────────────────────────────────────── --}}
@if(session('success')) <div class="alert alert-success alert-dismissible fade show" style="border-radius:8px; font-size:.875rem;"> <i class="fas fa-check-circle me-1"></i> {{ session('success') }} <button type="button" class="btn-close" data-bs-dismiss="alert"></button> </div>
@endif

@if($errors->any()) <div class="alert alert-danger alert-dismissible fade show" style="border-radius:8px; font-size:.875rem;"> <strong><i class="fas fa-exclamation-circle me-1"></i>Please fix the following:</strong> <ul class="mb-0 mt-2">
            ...
            <div class="card-body">
                <div class="row g-3">
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="text"
                               class="form-control"
                               value="{{ optional($currentEnrollment?->session)->session_name }}"
                               readonly>
                    </div>
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="text"
                               class="form-control"
                               value="{{ optional($currentEnrollment?->class)->class_name }}"
                               readonly>
                    </div>

                    <div class="col-md-4">
                        <label class="form-label">Change Class To</label>
                        <select name="class_id" class="form-select">
                            <option value="">— No Change —</option>

                            @foreach($classes as $class)
                                <option value="{{ $class->id }}"
                                    {{ old('class_id', optional($currentEnrollment)->class_id) == $class->id ? 'selected' : '' }}>
                                    {{ $class->class_name }}
                                </option>
                            @endforeach
                        </select>
